...
var CustomerCreateComponent = /** @class */ (function () {
    function CustomerCreateComponent(dataService, router) {
    ...
    CustomerCreateComponent.prototype.save = function () {
        var _this = this;
        this.dataService.createCustomer(this.customer).subscribe(function (data) { return _this.router.navigateByUrl("/"); });
    };
